...
const RegisteredEvents = ({ onNavigate, onEventClick, onBack, onViewResults }) => {
        ...
        <main className="flex-1 p-6">
          ...
          {registeredEvents.length > 0 ? (
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex-shrink-0 ml-4">
                      <button
                        ...
                        className="px-4 py-2 bg-[var(--color-button-primary)] text-white text-sm rounded-lg hover:bg-[var(--color-button-primary-hover)] transition-colors"
                      >
                        View Results
                      </button>
                    </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-400 text-sm mt-2">Register for some events to see them here.</p>
            </div>
          )}
        </main>
      </div>
